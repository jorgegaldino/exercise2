...
public class UsuarioResource {
	...
	@Operation(summary = "Alterar Usuário", description = "Alterar um Usuário", tags = { "Usuário API" })
	@PutMapping
	public ResponseEntity<MensagemDTO> alterarUsuario(@Valid @RequestBody UsuarioDTO usuarioDTO) {
	...
	public ResponseEntity<MensagemDTO> salvarUsuario(@Valid @RequestBody UsuarioDTO usuarioDTO) {
		String mensagemValidacao = service.validar(usuarioDTO);
